 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |      |      |      |PnScn |ScLock|Pause |                    | INS  | PgUp |  UP  | PgDn | ^    | F12  |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
...
//|-------+-------+-------+-------+-------+-------+                    |-------+-------+-------+-------+-------+-------+
   _______,_______,_______,KC_PSCR,KC_SLCK,KC_PAUS,                      KC_INS,KC_PGUP, KC_UP ,KC_PGDN,_______, KC_F12, \
//|-------+-------+-------+-------+-------+-------+                    |-------+-------+-------+-------+-------+-------+
    KC_F1 , KC_F2 , KC_F3 , KC_F4 , KC_F5 , KC_F6 ,                     KC_HOME,KC_LEFT,KC_DOWN,KC_RGHT,KC_END ,_______, \
//|-------+-------+-------+-------+-------+-------+-------+    |-------+-------+-------+-------+-------+-------+-------+
   _______,_______,_______,_______,_______,_______, BREAK ,     KC_DEL ,_______,KC_PGDN,_______,_______,_______,_______, \
//|-------+-------+---+---+---+---+---+---+---+---+---+---+    |---+---+---+---+---+---+---+---+---+---+-------+-------+
...
//|-------+-------+-------+-------+-------+-------+                    |-------+-------+-------+-------+-------+-------+
   _______,_______, PW_LT , PW_LSQ,PW_LBRA,PW_LPAR,                     PW_RPAR,PW_RBRA, PW_RSQ, PW_GT ,PW_PIPE,SE_QUOT, \
//|-------+-------+-------+-------+-------+-------+-------+    |-------+-------+-------+-------+-------+-------+-------+
...
//|-------+-------+-------+-------+-------+-------+                    |-------+-------+-------+-------+-------+-------+
   _______, KC_1  , KC_2  , KC_3  , KC_4  , KC_5  ,                      KC_6  , KC_7  , KC_8  , KC_9  , KC_0  ,SE_DIAE, \
//|-------+-------+-------+-------+-------+-------+                    |-------+-------+-------+-------+-------+-------+
   _______,_______, PW_LT , PW_LSQ,PW_LBRA,PW_LPAR,                     PW_RPAR,PW_RBRA, PW_RSQ, PW_GT ,PW_PIPE,SE_LABK, \
//|-------+-------+-------+-------+-------+-------+-------+    |-------+-------+-------+-------+-------+-------+-------+
   _______,_______,_______,_______,_______,_______,_______,     TG_ADJ ,_______,_______,_______,_______,PW_TILD,_______, \
//|-------+-------+---+---+---+---+---+---+---+---+---+---+    |---+---+---+---+---+---+---+---+---+---+-------+-------+
                       _______,_______,_______,_______,             _______,_______,_______,_______ \
