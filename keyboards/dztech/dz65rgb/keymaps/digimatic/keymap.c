...
enum { _SV = 0, _SVD, _US, _DV = _US, _FL, _MAC, _FK, _NL };
...
[_SV] = LAYOUT_65_ansi( /* Base */
  ...
  LT(_FL,KC_NUBS), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,           KC_PGUP, \
         SHIFT_LP, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,SHIFT_RP,                   KC_UP,   KC_PGDN, \
          KC_LCTL, KC_LGUI, KC_LALT,                LT(_FL,KC_SPC),            KC_RALT,             MO(_FL), MO(_NL),          KC_LEFT, KC_DOWN, KC_RGHT),
...
[_NL] = LAYOUT_65_ansi(
  ...
  _______,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,          _______,           KC_F12, \
